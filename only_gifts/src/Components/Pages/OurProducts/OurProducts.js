        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <NavLink className="nav-link active main fs20" aria-current="page" to="/"><b className="main">Home</b></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link fs20" to="/"><b className="blur">Our Product</b></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link fs20" to="/"><b className="blur">Our Clients</b></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link fs20" to="/"><b className="blur">About us</b></NavLink>
            </li>
          </ul>
        </div>
      </div>
